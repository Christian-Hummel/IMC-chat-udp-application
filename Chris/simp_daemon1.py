...
class ExampleDaemon:
    ...
    def daemon_listen(self):
        ...
        # ex_input = input("enter a flag ")


        #self.daemon_sock.sendto(ex_input.encode(), ("127.0.0.1", 7777))
    ...
    def client_listen(self):
        ...
        self.client_sock.sendto(b'0x02', ("127.0.0.1", 7778))
    ...
    def handshake(self, message, address):
        ...
        if message == b'0x02' and not self.connection:
            ...
            if reply == b'0x06':
                ...
                self.connection = True
                print(f"connection established as sender with {address}")
